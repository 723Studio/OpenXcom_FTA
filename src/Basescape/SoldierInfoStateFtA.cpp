...
SoldierInfoStateFtA::SoldierInfoStateFtA(Base* base, Soldier *soldier, DiplomacyFaction* faction) : _base(base), _faction(faction), _soldier(soldier), _listing(false), _redraw(false)
{
	initUi();
}
