...
void BattleItem::save(YAML::YamlNodeWriter writer, const ScriptGlobal *shared) const
{
	...
	if (_isCraftTurretAmmo)
		writer.write("isCraftTurretAmmo", _isCraftTurretAmmo);
